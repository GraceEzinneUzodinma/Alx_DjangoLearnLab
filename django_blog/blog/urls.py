...
from .views import UserRegisterView, ProfileUpdateView, BlogCreateView,BlogDeleteView, BlogDetailView, BlogUpdateView, BlogListView, CommentCreateView, CommentDeleteView, CommentUpdateView, search_posts, PostByTagListView
